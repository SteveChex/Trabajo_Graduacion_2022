...
class Segment:
    ...
    def givePoints(self):
        step = self._scale / 32
        for t in np.arange(0.0, self._scale + step, step):
            p = self._eval_xyz(self._polys, t)
            print(p)
...
#n0 = Node((-1, 0, z, yaw), q1=(-1-d, dy, z, 0))
#n1 = Node((1, 0, z, yaw), q1=(1-d, -dy, z, 0))
n0 = Node((-1, 0, z, yaw))
n1 = Node((1, 0, z, yaw))
#n2 = Node((1, 1, z, yaw))
#n3 = Node((0, 1, z, yaw))
...
if True:
    ...
    #for n in [n0, n1, n2, n3, n5]:
    #for n in [n0, n1, n2, n3, n5, n6]:
    #for n in [n0, n1, n2, n3, n5, n6, n7]:
    #for n in [n0, n1, n2, n3, n5, n6, n7, n8]:
    #for n in [n0, n1, n2, n3, n5, n6, n7, n8, n9]:
    #for n in [n0, n1, n2, n3, n5, n6, n7, n8, n9, n10]:
    
    #for n in [n0, n5, n6, n7, n8, n9, n10]:
    #for n in [n0, n5, n6, n7]:
    #for n in [n0, n8, n9, n10]:
    #for n in [n0, n1, n2, n3]:
