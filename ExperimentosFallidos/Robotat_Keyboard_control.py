...
# 
"""
Originalmente este codigo daba la posicion, pero le fue reemplazada esa
parte por el control con el teclado, debido a que ese codigo fallaba, 
aunque tuviera exactamente la misma configuración para el estimador de 
Kalman
"""
