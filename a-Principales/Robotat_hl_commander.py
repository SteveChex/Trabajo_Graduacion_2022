    ...
    with SyncCrazyflie(uri, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        try:
            ...
            while not keyboard.is_pressed('space'):
                #takeoff(self, absolute_height_m, duration_s, group_mask=ALL_GROUPS,yaw=0.0)
                #land(self, absolute_height_m, duration_s, group_mask=ALL_GROUPS,yaw=0.0)
                #stop(self, group_mask=ALL_GROUPS)
                #go_to(self, x, y, z, yaw, duration_s, relative=False,group_mask=ALL_GROUPS)
                #
